...
//http://123.207.47.61:8080/MyWeb/user/feedback/addFeedback?user_id=10000&feedback_title=捉住了一只bug&feedback_type=2&feedback_content=我不认识它&feedback_time=1522852284
     ...
     * @param iNetworkResponseListener1
     */
    void  commitFeedback(Context mContext, Integer user_id, String feedback_title, int feedback_type, String feedback_content, INetworkResponseListener iNetworkResponseListener1);
